    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_image', models.ImageField(blank=True, default='fun.jpg', null=True, upload_to='profile/', verbose_name='Profile Picture')),
                ('bio', models.CharField(blank=True, max_length=250, null=True, verbose_name='Bio')),
                ('last_seen', models.DateField(auto_now=True, null=True, verbose_name='Last seen')),
                ('created_at', models.DateField(auto_now_add=True, null=True, verbose_name='Created at')),
                ('deactivated_at', models.DateField(auto_now_add=True, null=True, verbose_name='Created at')),
                ('deactivation_reason', models.CharField(blank=True, null=True, verbose_name='Deactivation reason')),
