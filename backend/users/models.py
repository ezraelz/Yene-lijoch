...
class Profile(AbstractBaseUser, PermissionsMixin):
    ...
    profile_image = models.ImageField("Profile Picture", upload_to="profile/", default="fun.jpg")
    bio = models.CharField("Bio", max_length=100, blank=True, null=True)
    role = models.ForeignKey(Role, verbose_name="Role", on_delete=models.SET_NULL, blank=True, null=True)
    last_seen = models.DateField("Last seen", auto_now=True)
